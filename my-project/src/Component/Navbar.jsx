...
export default function Navbar() {
  ...
  return (
    ...
    <div className="navbar bg-base-100">
      {/* First Section: Book-related Content */}
      <div className="navbar-section navbar-start flex items-center">
        <a className="btn btn-ghost text-xl">Book Store</a>
      </div>
      
      {/* Second Section: Buttons and Menu */}
      <div className="navbar-section navbar-end flex items-center justify-between flex-grow">
